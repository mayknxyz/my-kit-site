...
|------|---------|----------|
| <a href="https://docs.anthropic.com/en/docs/claude-code" target="_blank" rel="noopener noreferrer">Claude Code</a> | AI coding assistant | Yes |
| <a href="https://git-scm.com/" target="_blank" rel="noopener noreferrer">Git</a> | Version control | Yes |
| <a href="https://www.gnu.org/software/stow/" target="_blank" rel="noopener noreferrer">GNU Stow</a> | Symlink manager | Yes |
| <a href="https://cli.github.com/" target="_blank" rel="noopener noreferrer">GitHub CLI (`gh`)</a> | GitHub operations | For ship commands |
